...
`;
    ...
    describe('validate', () => {
        ...
        it('should validate a model file', () => {
            ...
            file['type'] = 'model';
            file['content'] = model2;
            (() => file.validate([modelFile1])).should.not.throw();
        });
        ...
        it('should throw error with invalid model file', () => {
            ...
            file['type'] = 'model';
            file['content'] = model2;
            (() => file.validate([modelFile1])).should.throw();
        });
...
event SampleEvent {
  ...
  o String newValue
            ...
            (() => file.validate([modelFile])).should.not.throw();
        });
...
transaction SampleTransaction {
  ...
  o String newValue
            ...
            let modelManager = new ModelManager();
            let modelFile = new ModelFile(modelManager, model);
            (() => file.validate([modelFile])).should.throw();
        });
